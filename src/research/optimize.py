...
def run_optimization():
    print("🔎 [최적화 엔진] 10배 레버리지 기준 최적의 조합을 찾는 중...")
    ...
    print("\n" + "="*80)
    print(f"🏆 [ETH 10배 레버리지 전략 최적화 TOP 10] (분석 기간: {len(raw_df)} 캔들)")
    ...
    print(f"📈 10배율 적용 기대 수익률: {best['Return(%)']:.2f}%")
